        ...
        function mostraDatosPublicaciones()
        {
            ...
            */
            if(isset($_GET['pgnActual'])){
                if($_GET['pgnActual']==1){
                    header("Location:paginaPublicaciones.php");
                } else {
        ...
        function filtrarPublicaciones()
        {
            try{
                ...
                */
                ...
                $sql = "SELECT viviendas.id as total_id, tipo, zona, direccion, ndormitorios, precio, tamano, extras, observaciones,
                     fecha_anuncio, GROUP_CONCAT(fotos.foto SEPARATOR ',') AS fotos
                    FROM " . self::$TABLA . " LEFT OUTER JOIN fotos on viviendas.id = fotos.id_vivienda";
                ...
                if(isset($_GET['buscar'])) {
                    ...
                    if(!isset($_GET['garage']) && !isset($_GET['piscina']) && !isset($_GET['jardin'])){
                        ...
                        if (isset($_GET['piscina']) && isset($_GET['garage'])) {
                            $ex = $ex . "," . $_GET['garage'];
                        } else if (isset($_GET['jardin']) && isset($_GET['garage'])) {
                            $ex = $ex . "," . $_GET['garage'];
                        } else {
                            $ex = $ex . "" . $_GET['garage'];
                        }
